...
<div id="DIFFICULITY_NUMBER"  style="display:none"><?php echo $postchk->getPostValue('difficulity_number') ?></div>
...
<script src="./js/SpriteComplete.js?<?php echo date('YmdHis') ?>"></script>
